...
abstract class SudokuData {
    companion object {
    private val boardQuizze = arrayOf(
    ...
    private val boardSolution:Array<String> = arrayOf(
        ...
        fun getQuizze(index: Int): String {
            return boardQuizze[index]
        }

        fun getSolution(index: Int): String {
            return boardSolution[index]
        }
    }
}
